...
import { exportTransactionsToCSV } from '@/app/dashboard/keuangan/actions';
...
export default function ExportButton() {
  ...
  const handleExport = async () => {
    ...
    const result = await exportTransactionsToCSV(query, jenis);
    ...
    if (result.error) {
      ...
      link.setAttribute('download', `laporan-keuangan-${date}.csv`);
